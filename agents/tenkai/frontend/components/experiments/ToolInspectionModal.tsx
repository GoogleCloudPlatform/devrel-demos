            ...
            <div className="panel w-full max-w-4xl max-h-full flex flex-col bg-background shadow-2xl border-border animate-in zoom-in-95 duration-200">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <pre className={`p-4 rounded-xl border whitespace-pre-wrap font-mono leading-relaxed ${tool.status === 'success' ? 'bg-card border-border text-foreground' : 'bg-red-500/5 border-red-500/20 text-red-400'}`}>
