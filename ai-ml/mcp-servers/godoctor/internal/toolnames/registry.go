...
var Registry = map[string]ToolDef{
	...
	"file.read": {
		...
		Instruction:  "*   **`file_read`**: Deep-dive into a file's implementation.\n    *   **Usage:** `file_read(filename=\"pkg/utils.go\")`\n    *   **Outcome:** Complete implementation source and symbol index.",
	},
	"file.list": {
	...
	"go.install": {
		...
		Instruction:  "*   **`go_install`**: Add new tools or dependencies.\n    *   **Usage:** `go_install(packages=[\"golang.org/x/tools/cmd/goimports@latest\"])`\n    *   **Outcome:** Successful installation of the target package.",
	},
	"go.get": {
		InternalName: "go.get",
		ExternalName: "go_get",
	...
	"go.mod": {
		...
		Instruction:  "*   **`go_mod`**: Manage module requirements.\n    *   **Usage:** `go_mod(command=\"tidy\")`\n    *   **Outcome:** go.mod and go.sum are updated/cleaned.",
	},
	"go.lint": {
		...
		Instruction:  "*   **`go_lint`**: Analyze code quality.\n    *   **Usage:** `go_lint(command=\"run\", args=[\"./...\"])`\n    *   **Outcome:** A report of style and correctness issues.",
	},
	"go.modernize": {
	...
	"agent.review": {
		...
		Instruction:  "*   **`agent_review`**: Get an expert peer review.\n    *   **Usage:** `agent_review(file_content=\"...\")`\n    *   **Outcome:** Actionable suggestions and bug findings.",
	},
	"agent.specialist": {
		...
		Instruction:  "*   **`agent_specialist`**: Ask a question requiring deep research.\n    *   **Usage:** `agent_specialist(query=\"How does the auth flow handle token expiry?\")`\n    *   **Outcome:** Comprehensive investigative report.",
	},
}
