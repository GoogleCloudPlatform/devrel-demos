...
unset SSL_CERT_FILE REQUESTS_CA_BUNDLE PIP_CERT CURL_CA_BUNDLE GIT_SSL_CAINFO NODE_EXTRA_CA_CERTS https_proxy http_proxy HTTPS_PROXY HTTP_PROXY CLOUDSDK_CONTEXT_AWARE_USE_ECP_HTTP_PROXY CLOUDSDK_CONTEXT_AWARE_USE_CLIENT_CERTIFICATE CLOUDSDK_CONTEXT_AWARE_USE_MTLS_FOR_GRPC GOOGLE_API_CERTIFICATE_CONFIG
EOF
