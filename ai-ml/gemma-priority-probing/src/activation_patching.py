...
def main():
    ...
    ap.add_argument("--dataset", default="gemma-priority-probing/data/conflict_dataset.json")
    ap.add_argument("--out", default="gemma-priority-probing/data/patching_results.json")
